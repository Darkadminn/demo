...
public partial class AdminListOrder : Window
{
    DB dB = new DB();
    ...
    private void LoadOrders()
    {
        ...
        foreach(var order in orders)
        {
            ...
            /*stackPanelMain.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
            };*/

            /*stackPanelMiddle.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
            ...
            stackPanelRight.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
            ...
            /*borderMiddle.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
            ...
            borderRight.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
            ...
            borderMain.DoubleTapped += (a, args) =>
            {
                var window = new AdminEditingOrder(order);
                window.Show();
                this.Close();
